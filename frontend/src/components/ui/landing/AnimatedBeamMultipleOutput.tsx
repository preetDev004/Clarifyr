...
import { AnimatedBeam } from '@/components/magicui/landing/animated-beam';
...
>(({ className, children }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
        'z-10 flex size-12 items-center justify-center rounded-full border-2 border-border bg-white p-3 shadow-[0_0_20px_-12px_rgba(0,0,0,0.8)] dark:bg-teal-700/20',
        className
      )}
    >
      {children}
...
const Icons = {
  csv: () => (
    <Image width={40} height={40} src={'/xlsx.png'} alt={'csv'}></Image>
  ),
  pdf: () => (
    <Image width={40} height={40} src={'/pdf-icon.png'} alt={'pdf'}></Image>
  ),
  notion: () => (
    <svg
      width="100"

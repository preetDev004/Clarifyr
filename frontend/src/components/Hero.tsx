...
export default function Hero() {
  return (
    <section className="container mx-auto mt-16 px-4 py-12 sm:mt-28 sm:px-6 lg:px-8 lg:py-20">
      <div className="flex flex-col items-center justify-between lg:flex-row">
        <div className="relative z-10 mb-10 flex flex-col lg:mb-0 lg:w-1/2">
          <Badge />
          <h1 className="mb-6 bg-gradient-to-r from-custom-teal via-custom-darkblue to-custom-sage bg-clip-text font-display text-4xl font-bold text-transparent dark:from-white dark:to-white sm:text-5xl">
            AI-Powered 
            <WordRotate
        ...
        <div className="relative mt-10 hidden lg:mt-0 lg:block lg:w-1/2">
          <div className="absolute left-1/2 top-1/2 h-72 w-72 -translate-x-1/2 -translate-y-1/2 transform rounded-full bg-primary/20 blur-3xl filter"></div>
          <Image
            src="/landing.png"
          ...
          />
          <div className="absolute -bottom-5 -left-5 z-20 rounded-lg bg-muted p-4 shadow-lg dark:bg-custom-teal/50 sm:-bottom-10 sm:-left-10">
          ...
          <div className="absolute -right-5 -top-5 z-20 rounded-lg bg-muted p-4 shadow-lg dark:bg-custom-teal/50 sm:-right-10 sm:-top-10">
